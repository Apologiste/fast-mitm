...
fourni en annexe et joint en fichier, après réservation de coeurs en mode interactif. 
Ce script permet d’automatiser l’exécution de tous les tests 
...
La valeur maximale testée est \textbf{n = 36} avec un temps d’exécution 
d'environ $979$ secondes, soit près de \textbf{16 minutes}.
L'exécution séquentielle pour cette valeur de $n$
nécessite environ 864~Go de mémoire RAM \@ \\

Les tests n’ont pas été au-delà de cette valeur en raison de la consommation mémoire qui est 
